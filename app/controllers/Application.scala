...
import play.api.libs.iteratee.Iteratee    // 컴패니언 오브젝트로 이름이 EnvParser 이면 따로 import dksgownjeh ehla
...
object Application extends Controller {
  ...
  def index = Action.async { implicit request =>
    ...
    val loggingIterates = Iteratee.foreach[Array[Byte]] { (array: Array[Byte]) =>
